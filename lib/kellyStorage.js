...
var KellyStorage = new Object();
    ...
    KellyStorage.fieldsOrder = ['hidePostByRating', 'hideCommentByRating', 'offIfUnauth', '__additions__', 
                                'debug', 'delay', 'postLink', 'timeout', 'scrollOffset', 'scrollDelay', '_/additions/_'];

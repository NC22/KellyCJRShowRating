...
var KellyStorage = {    
        fields : {                    
            ...
            postLink : {type : 'string', default : 'http://old.reactor.cc/post/__POST_ID__'}, // query url for get unauth data for post (query currently hardcoded - method GET | API fetch)

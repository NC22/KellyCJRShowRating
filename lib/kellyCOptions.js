...
var KellyCOptions = new Object(); 
    ...
    KellyCOptions.showPage = function(cfg) {
        ...
        var handler = KellyCOptions, html = '';        
            ...
            handler.copyright = ' &copy; <a href="http:' + '//joy' + 'reactor.cc/tag/not' + 'aRo' + 'bot" target="_blank">nrad' + 'iowave</a> |\
                                 <a href="http://' + 'kelly' + '.catface.' + 'ru">' + handler.getLoc('support_link') + '</a>';
        ...
        KellyShowRate.getInstance().callback('onOptionsInit', {page : handler.page});

/* 
    ...
    ToDo : check rating update in unauth mode
*/
...
function KellyShowRate(cfg) {
    ...
    this.init = function() {
        ...
        KellyStorage.load(function(cfg) {
            ...
            for (var i = 0; i < KellyShowRate.onLoadCallbacks.length; i++) KellyShowRate.onLoadCallbacks[i](handler);
